...
int CMainWindow::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	m_wndLabel.Create(_T("Icons"), WS_CHILD|WS_VISIBLE|SS_LEFT,
		CRect(m_cxChar * 50, m_cyChar * 2, m_cxChar * 82,
		m_cyChar * 2), this);

	m_wndIconListBox.Create(WS_CHILD|WS_VISIBLE|WS_VSCROLL|WS_BORDER|LBS_NOTIFY|LBS_NOINTEGRALHEIGHT,
						CRect(m_cxChar * 50, m_cyChar * 2, m_cxChar * 82, m_cyChar * 20), this, IDC_LISTBOX);
...
{
	int nCount = ::DragQueryFile(hDropInfo, (NULL) - 1, NULL, 0);
