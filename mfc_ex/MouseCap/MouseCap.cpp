...
CMainWindow::CMainWindow()
{
	...
	Create(strWndClass, _T("MouseCapture Demo(Capture Enable)"));
}
...
void CMainWindow::OnNcLButtonDown(UINT nHitTest, CPoint point)
{
	if(nHitTest == HTCAPTION)
	{
		...
		SetWindowText(m_bCaptureEnabled ? _T("MouseCaptureDemo(CaptureEnabled)") :
		_T("MouseCaptureDemo(CaptureDisabled)"));
	}
