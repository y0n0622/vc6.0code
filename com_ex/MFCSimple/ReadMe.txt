========================================================================
		ActiveX Control DLL : MFCSIMPLE
========================================================================

ControlWizard has created this project for your MFCSIMPLE ActiveX Control
...
that make up your MFCSIMPLE ActiveX Control DLL.
...
MFCSimpleCtl.h
	This file contains the declaration of the CMFCSimpleCtrl C++ class.

MFCSimpleCtl.cpp
	This file contains the implementation of the CMFCSimpleCtrl C++ class.

MFCSimplePpg.h
	This file contains the declaration of the CMFCSimplePropPage C++ class.

MFCSimplePpg.cpp
	This file contains the implementation of the CMFCSimplePropPage C++ class.

MFCSimpleCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CMFCSimpleCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file MFCSimple.rc.
